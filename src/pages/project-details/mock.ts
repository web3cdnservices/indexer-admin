...
export const projectItem = {
  description:
    "Aims to deliver analytics & historical data for Sushi's incentivized pools on the MasterChef contract. Includes Kashi KMP & Exchange SLP tokens that are staked for Sushi emissions. Official Sushi Subgraph",
